...
parser.add_argument("--gpus", type=int, default=0,
                    help="gpus, write -1 if gpu is not supported")
...
parser.add_argument("--test_by_arity", action='store_true', default=False,
                    help="test by arity, only supported when dataset is JF17K")
...
parser.add_argument("--neg_ratio", "-nr", type=int, default=32,
...
parser.add_argument('--positional_encoding','-pe', type=str, default="static", choices=["learnable", "static", "constant", "one-hot"],
                    help='the positional encoding method')
